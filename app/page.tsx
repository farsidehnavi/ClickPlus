    ...
    <div className={style.Main}>
      ...
      <div className={style.DarkPage}>
        <div className={style.FirstRow}>
          ...
          <div className={style.FirstRowTextSection}>
            <p className={style.WTitle}>آینده هوش مصنوعی، فقط با یک کلیک</p>
            <p className={style.WSubtitle}>
              ClickPlus دسترسی سریع و ساده به پیشرفته‌ترین ابزارهای هوش مصنوعی
              متن و تصویر — بدون دردسر، بدون محدودیت
            </p>
            <p className={style.Text}>
              هر آنچه یک حرفه ای برای زندگی نیاز دارد را یکجا جمع کرده ایم تا با
              یک کلیک به آن دسترسی داشته باشید.
